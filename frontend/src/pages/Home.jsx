...
function Home() {
  return (
    <>
      ...
      <Link to='/new-ticket' className='flex items-center justify-center border-4 mb-6 lg:py-3 py-2 rounded-xl'>
      ...
      <Link to='/tickets' className='flex items-center justify-center border-4 lg:py-3 py-2 rounded-xl'>
